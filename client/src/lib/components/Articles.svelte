...
<div class="container mt-5 mb-5 {$colorTheme == "Light" ? 'bg-neutral-100 text-black' :  ($colorTheme == "Dark" ? 'bg-neutral-400 text-white' : "bg-neutral-900 text-yellow-500")}">
  ...
  <div class="row gap-4">
    <div class="col mb-5" style="max-width: 50%; max-height: 250px">
      ...
      <p><a class="btn {$colorTheme == "Light" ? 'bg-cyan-200 hover:bg-cyan-100 text-black':  ($colorTheme == "Dark" ? 'bg-indygo-500 hover:bg-indygo-400 text-white' : "bg-yellow-500 hover:bg-yellow-300 text-white")}" href="/#/subPage/article" role="button">Read article »</a></p>
    </div>
    <div class="col mb-5" style="max-width: 50%; max-height: 250px;">

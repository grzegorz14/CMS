...
<div class="container mt-5 mb-5 {colorTheme == "Light" ? 'bg-white t-black' :  (colorTheme == "Dark" ? 'bg-dark t-white' : "bg-black text-yellow")}">
  ...
  <div class="row gap-4">
    <div class="col mb-5" style="max-width: 50%; max-height: 250px">
      ...
      <p><a class="btn {colorTheme == "Light" ? 'bg-cyan t-black':  (colorTheme == "Dark" ? 'bg-indygo t-white' : "bg-yellow t-white")}" href="/#/subPage/article" role="button">Read article »</a></p>
    </div>
    <div class="col mb-5" style="max-width: 50%; max-height: 250px;">
